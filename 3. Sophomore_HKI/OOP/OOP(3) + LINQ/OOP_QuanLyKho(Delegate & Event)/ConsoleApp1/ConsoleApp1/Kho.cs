...
{ 
    ...
    public class Kho
    {
        ...
        public delegate void Handler_Nhap(Kho sender, KhoEvent e);
        public delegate void Handler_Tra(Kho sender, KhoEvent e);
        public delegate void Handler_Ban(Kho sender, KhoEvent e);
        ...
        public void TaoKhoHang(SanPham ao, SanPham quan)
        {
        ...
        public void Xuat(SanPham ao, SanPham quan)
        {
            Console.WriteLine();
